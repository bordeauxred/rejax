...
# Seeds:        4 (PART 2: seeds 30-33, sequential for learning curves)
...
#          → ~32h on H100 (run part1 on another GPU for full 8 seeds)
#
# Usage:
...
NUM_ENVS=${4:-2048}
EVAL_FREQ=${5:-500000}
BASE_SEED=${6:-30}  # Seeds 30-33 (part 2 of balanced 26-33 split)
...
echo "=============================================================="
echo "PAPER EXPERIMENT: 64x4 + PERMUTATIONS + 20 CYCLES (PART 2/2)"
echo "=============================================================="
