...
# Seeds:        8 (rliable: 4 games × 8 seeds = 32 datapoints for bootstrap)
# Games:        4 (Breakout, Asterix, SpaceInvaders, Freeway)
# Permutation:  YES - channels + game order
#
# ITERATIVE RUNS:
#   You can run seeds in batches and merge later:
#     ./scripts/benchmark_continual_minatar_paper_64x4.sh 15000000 20 8 2048 500000 26  # seeds 26-33 (balanced)
#     ./scripts/benchmark_continual_minatar_paper_64x4.sh 15000000 20 2 2048 500000 34  # seeds 34-35 (add more)
#   Results go to same folder, W&B groups by config name.
#
...
#          → ~64h on H100 (can add 2 more seeds later for 10 total)
#
# Usage:
#   ./scripts/benchmark_continual_minatar_paper_64x4.sh                               # Full 8 seeds (26-33)
#   ./scripts/benchmark_continual_minatar_paper_64x4.sh 15000000 20 4 2048 500000 26  # First 4 seeds
#   ./scripts/benchmark_continual_minatar_paper_64x4.sh 1000000 2 1 2048 100000 26    # Quick test
...
# Fixed experiment name for merging iterative runs
...
# Log start time
echo "Started at: $(date) | Seeds $BASE_SEED-$((BASE_SEED + NUM_SEEDS - 1))" | tee -a "$OUTPUT_DIR/run.log"
...
echo ""
echo "Finished at: $(date) | Seeds $BASE_SEED-$((BASE_SEED + NUM_SEEDS - 1))" | tee -a "$OUTPUT_DIR/run.log"
