#!/bin/bash
# Paper Baseline: L2-Init regularization (64x4 MLP)
#
# Same setup as main paper experiment but with L2-Init baselines
# Tests two coefficients: 0.001 and 0.01
#
# Network:      64-64-64-64 MLP
# Steps/game:   15M
# Cycles:       20
# Methods:      mlp_l2_init_small4 (0.001), mlp_l2_init_small4_0.01 (0.01)
# Seeds:        8 (all parallel, ~3GB each)
...
#
# Usage:
#   ./scripts/benchmark_continual_minatar_paper_64x4_l2init.sh                    # Full run
#   ./scripts/benchmark_continual_minatar_paper_64x4_l2init.sh 1000000 2 500000   # Quick test
...
echo "=============================================================="
echo "L2-INIT BASELINE: 64x4 + PERMUTATIONS + 20 CYCLES"
echo "=============================================================="
...
echo "=============================================================="
echo "Configs:"
echo "  1. mlp_l2_init_small4 - L2-Init λ=0.001"
echo "=============================================================="
...
echo "Started at: $(date)" | tee -a "$OUTPUT_DIR/run_l2init.log"
...
for SEED in "${SEEDS[@]}"; do
    ...
    uv run python scripts/bench_continual.py \
        ...
        > "$OUTPUT_DIR/seed_${SEED}_l2init.log" 2>&1 &
...
echo "Logs: $OUTPUT_DIR/seed_*_l2init.log"
echo ""
echo "Monitor with:"
echo "  watch -n 5 nvidia-smi"
echo "  tail -f $OUTPUT_DIR/seed_26_l2init.log"
echo ""
...
echo ""
echo "=============================================================="
echo "Finished at: $(date)" | tee -a "$OUTPUT_DIR/run_l2init.log"
