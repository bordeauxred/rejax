#!/bin/bash
# Paper Baseline: WSN (Weight Spectral Norm) (64x4 MLP)
#
# Same setup as main paper experiment but with WSN regularization
...
# Steps/game:   15M
# Cycles:       20
# Methods:      mlp_wsn_small (WSN regularization λ=0.001)
...
#
# Usage:
#   ./scripts/benchmark_continual_minatar_paper_64x4_wsn.sh                         # Full run (seeds 26-33)
#   ./scripts/benchmark_continual_minatar_paper_64x4_wsn.sh 1000000 2 500000        # Quick test
...
# Limit each process to 7% of GPU memory (~5.6GB on H100)
# 8 processes × 5.6GB = 45GB total
export XLA_PYTHON_CLIENT_MEM_FRACTION=0.07
...
echo "=============================================================="
echo "WSN BASELINE: 64x4 + PERMUTATIONS + 20 CYCLES"
echo "=============================================================="
...
echo "=============================================================="
echo "Configs:"
echo "  1. mlp_wsn_small - WSN (Weight Spectral Norm, λ=0.001)"
echo "=============================================================="
...
echo "Started at: $(date)" | tee -a "$OUTPUT_DIR/run_wsn.log"
...
for SEED in "${SEEDS[@]}"; do
    ...
    uv run python scripts/bench_continual.py \
        ...
        > "$OUTPUT_DIR/seed_${SEED}_wsn.log" 2>&1 &
...
echo "Logs: $OUTPUT_DIR/seed_*_wsn.log"
echo ""
echo "Monitor with:"
echo "  watch -n 5 nvidia-smi"
echo "  tail -f $OUTPUT_DIR/seed_26_wsn.log"
echo ""
...
echo ""
echo "=============================================================="
echo "Finished at: $(date)" | tee -a "$OUTPUT_DIR/run_wsn.log"
